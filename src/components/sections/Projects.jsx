...
const Projects = () => {
  return (
    <section className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="backdrop-blur-[10px] grid grid-cols-1 md:grid-cols-2  mt-15 gap-8" data-aos="fade-up">
        {educationItems.map((item, index) => (
          <div
            key={index}
            className="border px-5 py-6 rounded-xl hover:border-[#007ea7]/80 transition-all duration-500 bg-neutral-800/30 border-neutral-700"
  ...
  <h2
    className="text-2xl md:text-3xl font-semibold mb-6 text-white relative inline-block"
    data-aos="fade"
  >
    Aptitudes
    <span className="absolute left-8 -bottom-3 w-11 bg-[#00a8e8] pb-0.5"></span>
  </h2>
</div>
