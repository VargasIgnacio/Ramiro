    ...
    >
      <div className="max-w-6xl mx-auto my-10 flex flex-col md:flex-row justify-between items-center">
        ...
        <p className="text-[#0094cc] font-medium 40:text-base mb-4 md:mb-0">
          Tu proyecto, desarrollado con compromiso y precisión.
        </p>
      ...
      <div className="text-center mt-10 text-xs text-neutral-500 space-y-1">
        <p>© 2025 Ramiro Borello. Todos los derechos reservados.</p>
        <a className='text-neutral-300 hover:text-[#0094cc] transition-all duration-300' target='blank_' href="https://www.kiad.dev">Developed by KIAD</a>
      </div>
    </motion.footer>
  );
};
